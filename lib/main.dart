...
class _MyHomePageState extends State<MyHomePage> {
  List<MySuperHero> items =  List<MySuperHero>();

  _MyHomePageState() {
    items.add( MySuperHero("assets/iron_man.png", "Iron Man",
    ...
    items.add( MySuperHero("assets/captain_america.png", "Captain America",
    ...
    items.add( MySuperHero("assets/black_widow.png", "Black Widow",
